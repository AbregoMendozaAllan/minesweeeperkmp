...
//add include(":feature:play") to settings.gradle.kts
...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "Play"//change to Module name
            isStatic = true
        }
    }
    ...
    wasmJs {
        moduleName = "play"//change to Module name
        browser {
            val rootDirPath = project.rootDir.path
            val projectDirPath = project.projectDir.path
            commonWebpackConfig {
                outputFileName = "play.js"//change to Module name
...
android {
    namespace = "com.eonarma.minesweeperkmp.play"//add module name
